...
cairo_pdf(paste("FUNGIALL.pdf", sep = ""), width = 35, height =15)
...
cairo_pdf(paste("FUNGIAGIORGITIKO.pdf", sep = ""), width = 35, height =15)
...
cairo_pdf(paste("FUNGIXINOMAVRO.pdf", sep = ""), width = 35, height =15)
...
cairo_pdf(paste("FUNGIVIDIANO.pdf", sep = ""), width = 35, height =15)
